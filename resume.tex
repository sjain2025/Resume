...
\begin{document}
    ...
    \begin{onecolentry}
        \begin{highlights}
            ...
            \item \textbf{Relevant Courses:} Data Structures and Algorithms, Computer Systems, Functional Programming, Artificial Intelligence, Machine Learning, Discrete Math, Linear Algebra, Multivariable Calculus, Computer Vision, Mobile and Web Application Development
        \end{highlights}
    \end{onecolentry}
    ...
    \begin{onecolentry}
        \textbf{Languages and Operating Systems:} Python, Java, C, HTML/CSS, JavaScript, TypeScript, C++, SQL, MATLAB, Linux, Windows, macOS
    \end{onecolentry}
    \vspace{-0.1cm}
    \begin{onecolentry}
